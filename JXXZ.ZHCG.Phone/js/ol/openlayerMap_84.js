(function(window, ol) {
	function OpenlayerMap(options) {
		...
		var op = extend({
			...
			center: [120.07827758789064, 33.24650573730469],
			zoom: 9,
			imgPath: 'point.png'
		}, options);
		...
		tileLayerSource1 = new ol.source.Tile({
		...
		tileLayerSource2 = new ol.source.WMTS({
            url: 'http://10.73.1.48:9070/JXPDServerCore/rest/services/JXEMAPAnno/MapServer/WMTS',
            layer: 'cva',
            format: 'tiles',
            tileGrid: new ol.tilegrid.WMTS({
                origin: ol.extent.getTopLeft(projectionExtent),
