                    ...
                    items: [
                            {
                                ...
                                items: [
                                    ...
                                    },
                                    {
                                        ...
                                        listeners: {
                                            render: function () {
                                                me.down('combo[name=middleteam]').removeListener('select', 'clChangeShowInfo');
                                                me.down('combo[name=middleperson]').addListener('select', 'clChangeShowInfo');
                                            },
                                            change: function (obj) {
                                                if (obj.getValue().assigntype == '2017021410240002') {
                                                    ...
                                                    me.down('combo[name=middleperson]').removeListener('select', 'clChangeShowInfo');
                                                    me.down('combo[name=middleteam]').addListener('select', 'clChangeShowInfo');
                                                    var cyCombo = me.down('combo[name=middleteam]');
                                                    cyCombo.clearValue();
                                                    ...
                                                    me.down('combo[name=middleperson]').addListener('select', 'changeShowInfo');
                                    ...
                                    },
                                    {
                                        ...
                                        listeners: {
                                            select: function () {
                                                if (me.down('combo[name=person]').value != null) {
                                                    Ext.Ajax.request({
                                                        url: 'api/User/GetUserById?userid=' + me.down('combo[name=person]').value,
                                                        method: 'get',
                                                        async: false,
                                                        success: function (response) {
                                                    ...
                                                    me.down('checkbox[name=message]').boxLabel = "短信提醒  （" + me.down('combo[name=person]').rawValue + "：" + phone + "）";
