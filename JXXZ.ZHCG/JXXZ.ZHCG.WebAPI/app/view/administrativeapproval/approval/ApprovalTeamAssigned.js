                                            ...
                                            },
                                            {
                                                ...
                                                listeners: {
                                                    change: function (obj)
                                                    {
                                                        ...
                                                        {
                                                            me.down('hidden[name=tmpPhone]').setValue(me.down('combo[name=nextuserid]').displayTplData[0].phone);
                                                        }
                                                    }
                                                }
                                            },
                                                    ...
                                                    click: function (obj)
                                                    {
                                                        if (me.down('combo[name=nextuserid]').value != null)
                                                        {
                                                            ...
                                                            if (me.down('displayfield[name=dealusername]').value == null)
                                                            {
                                                                ...
                                                                var phone = "暂无工作号";
                                                                var flag = false;
                                                                if (me.down('hidden[name=tmpPhone]').value != null)
                                                                {
                                                                    phone = me.down('hidden[name=tmpPhone]').value;
                                                                    flag = true;
                                                                }
                                                                //拼接页面短信显示
                        ...
                        items: [
                            {
                                ...
                                listeners: {
                                    render: function ()
                                    {
                                        CreateAarcgisMap('', '事件坐标', 1, 1, '', this);
                                    }
                                }
                            },
                        ],
