            ...
            items: [{
                        ...
                        items: [
                            {
                                ...
                                listeners: {
                                    render: function ()
                                    {
                                        CreateAarcgisMap('', '事件坐标', 0, 1, me.content.location != null ? me.content.location : '', this);
                                    }
                                }
                            },
                        ],
                ...
                listeners: {
                    ...
                    tabchange: function (tabPanel, newCard, oldCard, eOpts)
                    {
                        ...
                        {
                            newCard.addListener('render', CreateAarcgisMap('', '事件坐标', 0, 1, me.content.location != null ? me.content.location : '', newCard), this);
                        }
                    }
                }
            }],
