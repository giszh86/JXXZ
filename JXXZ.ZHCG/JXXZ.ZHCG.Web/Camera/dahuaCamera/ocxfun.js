...
function ButtonLogin_onclick() {
    ...
    //默认自建视频
    var szIp = "10.200.13.137";
    var nPort = "9000";
    var szUsername = "admin";
    var szPassword = "admin";
...
function ButtonPtzDirection_onclick(nDirects) {
    ...
    var szCameraId = document.getElementById("textCameraID").value;
    nDirect = nDirects;
    var nStep = 2;//document.getElementById("selectPtzDirectionStep").value;
...
function ButtonPtzCameraOperation_onclick(nOpers) {
    ...
    var szCameraId = document.getElementById("textCameraID").value;
    nOper = nOpers;
    var nStep = 2;// document.getElementById("selectCameraStep").value;
...
function ButtonQueryRecord_onclick() {
    var obj = document.getElementById("DPSDK_OCX");
    var szCameraId = document.getElementById("textCameraID").value;
    var nRecordSource = 3;// document.getElementById("selectRecordSource").value;
    var nRecordType = 0;// document.getElementById("selectRecordType").value;
    ...
    alert("szCameraId:" + szCameraId + "--nRecordSource:" + nRecordSource + "--nRecordType:" + nRecordType + "--nStartTime:" + nStartTime + "--nEndTime:" + nEndTime);
