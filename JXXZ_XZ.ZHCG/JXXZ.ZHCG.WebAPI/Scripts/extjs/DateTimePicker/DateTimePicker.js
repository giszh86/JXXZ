...
Ext.define('Ext.ux.DateTimePicker', {
     ...
     */
    renderTpl: [
        '<div id="{id}-innerEl" data-ref="innerEl" role="presentation" style="background: white;">',
            '<div class="{parent.baseCls}-header" style="text-align: center;background: #eee;">',
                '<div id="{id}-prevEl" data-ref="prevEl" class="{parent.baseCls}-prev {parent.baseCls}-arrow" role="presentation" title="{prevText}"></div>',
                '<div id="{id}-middleBtnEl" data-ref="middleBtnEl" class="{parent.baseCls}-month" role="heading">{%this.renderMonthBtn(values, out)%}</div>',
                '<div id="{id}-nextEl" data-ref="nextEl" class="{parent.baseCls}-next {parent.baseCls}-arrow" role="presentation" title="{nextText}"></div>',
            '</div>',
            '<br />',
            '<table role="grid" id="{id}-eventEl" data-ref="eventEl" class="{baseCls}-inner" cellspacing="0" tabindex="0" style="width:100%;">',
                '<thead>',
                    '<tr role="row">',
                        '<tpl for="dayNames">',
                            '<th role="columnheader" class="{baseCls}-column-header" aria-label="{.}">',
                                '<div role="presentation" class="{baseCls}-column-header-inner">{.:this.firstInitial}</div>',
                            '</th>',
                        '</tpl>',
                    '</tr>',
                '</thead>',
                '<tbody>',
                    '<tr role="row">',
                        '<tpl for="days">',
                            '{#:this.isEndOfWeek}',
                            '<td role="gridcell">',
                                '<div hidefocus="on" class="x-datepicker-date"></div>',
                            '</td>',
                        '</tpl>',
                    '</tr>',
                '</tbody>',
