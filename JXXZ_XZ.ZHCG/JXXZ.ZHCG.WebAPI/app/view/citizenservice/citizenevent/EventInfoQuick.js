        ...
        Ext.Ajax.request({
            ...
            success: function (response) {
                if (response.responseText != null) {
                    ...
                    nqzzname = jsonstr.nqname + ',' + jsonstr.zzname;
                }
            }
        })
                                ...
                                items: [
                                    ...
                                    },
                                   {
                                    ...
                                    },
                                    {
                                        ...
                                        items: [
                                            {
                                                ...
                                                hidden: (me.record.get('wfdid') == '2017021410240003' && dType == 2 && $.cookie('ROLE_IDS').indexOf('3') >= 0) ? true : false,
                                        ...
                                        listeners: {
                                            afterrender: function (obj) {
                                                if (me.record.get('wfdid') == '2017021410240003' && dType == 2 && $.cookie('ROLE_IDS').indexOf('3') >= 0){
                                    ...
                                    },
                                    {
                                        ...
                                        name: 'myd',
                                        xtype: 'radiogroup',
                                        hidden: ((this.record.get('wfdid') == '2017021410240003' && dType == 1) || (me.record.get('wfdid') == '2017021410240003' && dType == 2 && $.cookie('ROLE_IDS').indexOf('3') >= 0) || this.record.get('wfdid') == '2017021410240001') ? true : false,
