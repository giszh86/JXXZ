Ext.define('TianZun.view.administrativeapproval.approval.ApprovalTeamerDeal', {
    ...
    initComponent: function ()
    {
        ...
        var filestore = Ext.create('TianZun.store.administrativeapproval.Approval.GetFileUpload', { proxy: { type: 'ajax', extraParams: { wfsuid: me.content == null ? "0" : me.content.wfsuid } } });
        this.items = [{
            xtype: 'form',
            border: false,
            autoScroll: true,
