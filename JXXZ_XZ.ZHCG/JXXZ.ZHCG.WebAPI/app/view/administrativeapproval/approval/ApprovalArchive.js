Ext.define('TianZun.view.administrativeapproval.approval.ApprovalArchive', {
    extend: 'TianZun.ux.Window',
    alias: 'widget.approvalArchive',
    title: '归档',
    layout: 'fit',
    requires: [
    ...
    initComponent: function ()
    {
        ...
        var filestore2 = Ext.create('TianZun.store.administrativeapproval.Approval.GetFileUpload', { proxy: { type: 'ajax', extraParams: { wfsuid: me.content == null ? "0" : me.content.wfsuid } } });
                                                            ...
                                                            memeberitem = {
                                                                ...
                                                                items: [
                                                                    ...
                                                                    },
                                                                    {
                                                                        ...
                                                                        titleNew: '附件',
                                                                        store: null,
                                                                        filelist:eachmemberitem.filelist,
