...
Ext.define('TianZun.view.reportcenter.reportlist.XZSpecialPeriodEnvirProtReportDetail', {
    extend: 'TianZun.ux.Window',
    alias: 'widget.XZSpecialPeriodEnvirProtReportDetail',
                    ...
                    items: [
                        {
                            ...
                            exceltitle: me.title,
                            formsubmit: true,
                            extrapra: { reportid: 8, reportdate: reportdate, type: 1 },
                        },
                        //{
                        //    xtype: 'button',
                        //    text: '打印',
                        ...
                        columns: [
                            {
                                ...
                                columns: [
                                    ...
                                    {
                                        header: '城市道路扬尘污染防控数据统计', dataIndex: 'unitname', hideable: false, sortable: false, align: 'center',
                                        flex: 1,menuDisabled: true,
                                        columns: [
                                            {
