Ext.define('TianZun.view.legalcasemanager.documents.CYQZWPCLTZS', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.CYQZWPCLTZS',
    layout: 'fit',
    width: '100%',
    height: '100%',
    border: false,
                        ...
                        items: [
                             ...
                             },
                           {
                           ...
                           },
                              {
                                  ...
                                  format: 'Y-m-d',
                                  width: '99%',
                                  value: me.record == null ? null : me.record.qztzsj
                              },
                             {
                                 xtype: 'textarea',
                                 name: 'qzwp',
                                 ...
                                 margin: '10 0 10 0',
                                 height: 80,
                                 value: me.record == null ? null : me.record.qzwp
                             },
                              {
                                  xtype: 'textarea',
                                  name: 'yjdflgd',
                              ...
                              },
                             {
                                 ...
                                 store: Ext.create('TianZun.store.sys.Dictionary', {
                                     proxy: {
                                         type: 'ajax',
                                         method: "Get",
                                         url: configs.WebApi + 'api/DucumentTemplet/GetCYQZTZSList?wfsaid=' + panel.record.get('wfsaid') + '&ddid=45',
                                     }
                                 }),
                                 name: 'cyqztzsbh',
                                 valueField: 'wsbh',
                                 ...
                                 listeners: {
                                     beforerender: function (obj) {
                                         var cyqztzsbh = me.record == null ? null : me.record.cyqztzsbh
                                         obj.setValue(cyqztzsbh);
                                         this.getStore().load();
                                     },
...

                              {
                                  ...
                                  margin: '10 0 10 0',
                                  height: 80,
                                  value: me.record == null ? null : me.record.cljg
                              },
