Ext.define('TianZun.view.conservation.conservationtask.TaskReview', {
    extend: 'TianZun.ux.Window',
    alias: 'widget.taskReview',
    title: '任务审核',
    layout: 'fit',
    requires: [
                                  ...
                                  items: [
                                   {
                                       ...
                                       listeners: {
                                           'change': function (obj) {
                                               if (obj.lastValue.zptype == 'gd') {
                                                   me.down('textarea[name=dealcontent]').setFieldLabel('归档意见');
                                                   me.down('combo[name=middleteam]').hide();
                                                   me.down('combo[name=nextuserid]').hide();
                                                   //Ext.getCmp('nextwfuserids').setValue(me.record.pqrid);
                                               } else if (obj.lastValue.zptype == 'ht') {
                                               ...
                                               //else {
                                               //    me.down('textarea[name=dealcontent]').setFieldLabel('派遣意见');
                                               //    me.down('combo[name=middleteam]').show();
                                               //    me.down('combo[name=nextuserid]').show();
                                               //    //Ext.getCmp('nextwfuserids').setValue(me.record.pqrid);
                                               //}
                                           }
                                       }
