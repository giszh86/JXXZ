Ext.define('TianZun.view.reportcenter.reportlist.XZlandLawCaseHalfMonthReport', {
    extend: 'TianZun.ux.Window',
    alias: 'widget.XZlandLawCaseHalfMonthReport',
    ...
    initComponent: function ()
    {
        ...
        this.items = [{
            ...
            },
            {
                ...
                text: '提交',
                handler: 'onAddXZlandLawCaseHalfMonthOK'
            }, {
                text: '取消',
                handler: 'onClose'
            }]
